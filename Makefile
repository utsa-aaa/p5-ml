...
BinarySearchTree_public_test.exe: BinarySearchTree_public_test.cpp BinarySearchTree.hpp
	$(CXX) $(CXXFLAGS) $< -o $@
...
Map_public_test.exe: Map_public_test.cpp Map.hpp BinarySearchTree.hpp
	$(CXX) $(CXXFLAGS) $< -o $@
